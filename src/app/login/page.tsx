 ...
 * Login page — /login
 *
 * Supports Google SSO and email/password sign-in. After a successful
 * sign-in, exchanges the Firebase ID token for a server session cookie
 * via POST /api/auth/callback, then redirects to the intended destination
 * (or /recipes by default).
 */
